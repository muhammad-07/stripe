...
<body class="antialiased">
                                    ...
                                    <fieldset>
                                        <label>
                                            ...
                                            <input id="cardholder-name" type="text" class="field"
                                                value="Muhammad Begawala">
                                        </label>
                                    </fieldset>
                                    <div id="card-element" style="width: 100%; min-width:500px"></div>
                                    {{-- <button id="card-save-button">Save Card</button> --}}
                                    <button id="card-save-button">
                                        SAVE CARD <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
    ...
    <script>
        var stripe = Stripe(
            'pk_test_51LPOPnSAnG1jVDrCIR1hLfrKJEt33L9jJoqZARDdnOlrgKIq1IiyUL0rtUMNnULmcdUWS3W2IxNEMzGsp56b51nq004Xd8KZr1'
        );
        ...
        form.addEventListener('submit', function(event) {
            ...
            //   });
            fetch('/setup_intent').then(function(r) {
                    return r.json();
                })
                .then(function(result) {
                    if (result.error) {
                        ...
                        // Send setupIntentId to your server to save it
                        fetch('/save-card', {
                            method: 'POST',
                            headers: {
                            ...
                            stripe.confirmCardSetup(
                                ...
                                if (result.error) {
                                    ...
                                    debug('Setup Intent Payment Method: ' + result.setupIntent
                                        .payment_method);
